...
def iris_svm_version1iris_svm_version1():

    @task
    def read_table_irisdatasetv1_fun():

        inifile = 'iris_svm_version1iris_svm_version1.ini'
    ...
    @task
    def map_iris_dataset:irisdatasetv1_iris_svm_encoded_fun():

        inifile = 'iris_svm_version1iris_svm_version1.ini'
        in_dataset = 'iris_dataset:irisdatasetv1'
    ...
    @task
    def split_iris_svm_dataset_fun():
    ...
    map_iris_dataset:irisdatasetv1_iris_svm_encoded_op = map_iris_dataset:irisdatasetv1_iris_svm_encoded_fun()


    split_iris_svm_dataset_op = split_iris_svm_dataset_fun()


    read_table_irisdatasetv1_op>>split_iris_svm_dataset_op


    read_table_irisdatasetv1_op>>correlation_iris_svm_dataset_op


dag = iris_svm_version1iris_svm_version1()