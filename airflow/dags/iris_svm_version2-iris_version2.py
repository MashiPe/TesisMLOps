...
def iris_svm_version2iris_version2():

    @task
    def read_table_iris_svm_dataset_version1_fun():

        inifile = 'iris_svm_version2iris_version2.ini'
    ...
    read_table_iris_svm_dataset_version1_op>>correlation_iris_svm_dataset_op


dag = iris_svm_version2iris_version2()